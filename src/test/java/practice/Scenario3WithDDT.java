...
public class Scenario3WithDDT {
	...
	public static void main(String[] args) throws Throwable {
		...
		//CREATE ORGANISATION WITH INDUSTRY-CHEMICALS
		...
		String ORGANISATIONNAME = wb.getSheet("Organization").getRow(4).getCell(2).getStringCellValue();
		String INDUSTRYNAME=wb.getSheet("Organization").getRow(4).getCell(3).getStringCellValue();
		...
		//Step 2: Launch the Browser // Run Time Polymorphism - driver
				...
				//Step 6: create organisation with industry
				...
				System.out.println(ORGANISATIONNAME+" name saved " +INDUSTRYNAME+ " name saved ");
